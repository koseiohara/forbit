...
Python programers can read no-header binary files with this class like Fortran programers. This module, `binio.f90`, is based on Fortran, compiled by f2py, and wrapped by `forbit.py`.  
